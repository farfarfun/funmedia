...
def api_document_pop_window():
    with popup(t("📑API文档", "📑API Document")):
        ...
        put_markdown(t("#### 特点：", "#### Features:"))
        put_markdown(t("> 📦 开箱即用", "> 📦 Ready to use"))
        put_markdown(
            t(
        ...
        put_markdown(t("> 💰 成本优势", "> 💰 Cost advantage"))
        put_markdown(
            t(
        ...
        put_markdown(t("> ⚡️ 快速支持", "> ⚡️ Quick support"))
        put_markdown(
            t(
        ...
        put_markdown(t("> 🎉 拥抱开源", "> 🎉 Embrace open source"))
        put_markdown(
            t(
