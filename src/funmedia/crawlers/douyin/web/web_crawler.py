...
from funmedia.crawlers.douyin.web.endpoints import DouyinAPIEndpoints
# 抖音接口数据请求模型
from funmedia.crawlers.douyin.web.models import (
...
# 抖音应用的工具类
from funmedia.crawlers.douyin.web.utils import (AwemeIdFetcher,  # Aweme ID获取
